...
/// Replicon API first, then [`component`](AppComponentExt::component) to make
/// Lightyear prediction/interpolation metadata available for that same
/// component type.
///
